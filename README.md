...
**Pré-requisitos:** .NET SDK instalado e Credenciais do Google Cloud Console.
    ...
    5.  Atenção para o appsettings.json, você de criar um arquivo na raiz do projeto de mesmo nome e tipo, o git irá criar um apppsettings.Example.json, copie e cole no novo arquivo e configure as dependências.
    ---
